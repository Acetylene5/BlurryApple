...
def gral_acquireSPARTASlopeAndVoltData(nframes):
    case = "gravity"
    if( case=="canary" ):
        slope = pyfits.getdata("/home/egendron/Projets/GRAVITY/slopescanary_TS.fits") 
        volt = pyfits.getdata("/home/egendron/Projets/GRAVITY/voltscanary_TS.fits") 
        return slope, volt
    elif(case=="gravity"):
        # PLEASE REPLACE THIS EITHER BY A REAL ACQUISITION FROM SPARTA,
        # OR BY READING A FITS FILE ALREADY ACQUIRED
        ...
        #
        a = pyfits.getdata("/home/egendron/Projets/GRAVITY/LoopData_2.fits") 
        slope = a.field(4)
        volt = a.field(5)
        return slope, volt
...
def pupilTrack_slopesMethod(nframes, latency, Fs, norder):
    ...
    HOmi = pyfits.getdata("/home/egendron/Projets/GRAVITY/HORecnCalibrat.RESULT_IM.fits")
